...
rsync -u -e "ssh -i /home/zsun/.ssh/geobrain_upload_fire.pem" -avz /groups/ESS3/zsun/firecasting/data/output/output_xgboost_window_7_days_forecasting_with_new_yunyao_window_time_series_landuse_vhi/ chetana@129.174.131.229:/var/www/html/wildfire_site/data/
